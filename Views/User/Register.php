...
<form action="<?=BASE_URL?>User/register/" method="POST">
    ...
    <p>
        ...
        <input type="text" name="data[last_name]" placeholder="Introduce your last name" required>
    </p>
    <p>
        <label>Email</label>
        <input type="email" name="data[email]" placeholder="Introduce your email" required>
    </p>
    <p>
        <label>Date of Birth</label>
        <input type="text" name="data[date]" placeholder="Introduce your birth (dd/mm/yyyy)" required>
    </p>
    <p>
